...
- [x] **[Done]** [TASK-07.26-0021-apply-bp2-01-fix-001](TASK-07.26-0021-apply-bp2-01-fix-001/index.md) - `APP-07.26-0021-001` published після independent audits і whole-task human approval; implementation tasks не активовані.
- [x] **[Done]** [TASK-07.26-0014-prepare-phase-2-task-set](TASK-07.26-0014-prepare-phase-2-task-set/index.md) - Canonical Phase 2 task set підготовлено, незалежно перевірено та прийнято людиною без activation.
- [x] **[Done]** [TASK-07.26-0013-fix-internal-bp1-04-boundary-and-prepare-run](TASK-07.26-0013-fix-internal-bp1-04-boundary-and-prepare-run/index.md) - Internal-only BP1-04 boundary і RUN-001 підготовлено, незалежно перевірено та прийнято людиною.
...
- [x] **[Done]** [BP2-01 / TASK-07.26-0015](TASK-07.26-0015-bp2-01-minimal-public-read-contract/index.md) - Мінімальний public read contract прийнятий; FIX-001 applied owner TASK-0021, а `APP-07.26-0021-001` published.
- [x] **[Done]** [BP2-01A / TASK-07.26-0022](TASK-07.26-0022-bp2-01a-materialize-read-port/index.md) - Exact internal shared read-port/token source artifact materialized, independently reviewed і прийнятий людиною; BP2-02/BP2-03 згодом окремо активовані та завершені.
- [x] **[Done]** [BP2-02 / TASK-07.26-0016](TASK-07.26-0016-bp2-02-read-only-core-index/index.md) - Bounded internal read-only Core Resource slice реалізовано, незалежно перевірено та прийнято людиною.
...
- [ ] **[Review]** [P5-VS2 / TASK-07.26-0061](TASK-07.26-0061-p5-vs2-local-sqlite-multi-instance-sync/index.md) - Whole-task/FIX-001 approved/applied; post-application audit found two stale summaries, corrective FIX-002 pending separate approval. Support unclaimed, P5-STAB inactive.
...
Canonical-now boundary: `P5-RS1`, `P5-DG1`, `P5-DG2`, `P5-WP1 / TASK-0058`, `P5-HARD1 / TASK-0059` і `P5-VS1 / TASK-0060` accepted/completed; relevant fixations applied. `P5-VS2 / TASK-0061` review-ready з whole-task/FIX-001 approved/applied і corrective FIX-002 pending; `P5-STAB -> P5-AUD1` лишаються backlog/prepared та inactive.
