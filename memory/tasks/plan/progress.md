...
- [ ] **[Backlog]** [P5-VS1 / TASK-07.26-0060](TASK-07.26-0060-p5-vs1-lazy-refresh-public-integration/index.md) - Prepared lazy + experimental refresh/config/inspection integration; dependency satisfied, очікує окремої explicit activation.
...
Canonical-now boundary: `P5-RS1`, `P5-DG1`, `P5-DG2`, `P5-WP1 / TASK-0058` і `P5-HARD1 / TASK-0059` accepted/completed; P5-DG2 FIX-001 applied. `P5-VS1 -> P5-VS2 -> P5-STAB -> P5-AUD1` лишаються backlog/prepared та inactive.
